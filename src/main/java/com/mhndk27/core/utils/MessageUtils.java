...
public class MessageUtils {
        ...
        public static Component error(String msg) {
                return prefix("ERROR").append(
                                Component.text(msg, NamedTextColor.RED, TextDecoration.BOLD));
        }
        ...
        public static Component usage(String command) {
                return prefix("USAGE").append(Component.text("Type ", NamedTextColor.YELLOW))
                                .append(Component.text(command, NamedTextColor.GREEN,
                                                TextDecoration.BOLD))
                                .append(Component.text(" to use the command.",
